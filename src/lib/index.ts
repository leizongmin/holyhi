...
export class Store {
  ...
  public forFields(...fields: string[]): Subscriber {
    return new Subscriber(this).forFields(fields);
  }

  public allFields(): Subscriber {
    return new Subscriber(this).allFields();
  }
...
export class Subscriber {
  ...
  public forFields(fields: string[]): this {
    this.fields = fields;
    return this;
  }
